...
#
# 실행 예시:
#   export ROS_DOMAIN_ID=6 && ros2 launch ulsan_bridge bridge_launch.py  # LIMO 1
#   export ROS_DOMAIN_ID=7 && ros2 launch ulsan_bridge bridge_launch.py  # LIMO 2
...
def launch_setup(context):
    config_dir = os.path.join(get_package_share_directory('ulsan_bridge'), 'config')
    behaviour_config_dir = os.path.join(
        get_package_share_directory('ulsan_behaviour'), 'config'
    )
