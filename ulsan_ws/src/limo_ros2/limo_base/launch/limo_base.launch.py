...
def generate_launch_description():
    ...
    # [멀티로봇] namespace='limo' 제거.
    # 원본에 namespace='limo' 하드코딩 시 PushRosNamespace가 무시되어
    # /limo/cmd_vel, /limo/odom으로 고정됨 → Nav2와 토픽 불일치로 모터 미동작.
    # 제거 후 navigation_diff_launch.py의 PushRosNamespace가 올바르게 적용됨.
