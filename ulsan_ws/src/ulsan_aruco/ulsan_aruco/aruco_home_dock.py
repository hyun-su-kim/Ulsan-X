...
class ArucoHomeDock(Node):
    ...
    def __init__(self):
        ...
        markers_file = str(get_package_share_directory('ulsan_aruco')) + '/config/markers.yaml'
        ...
        waypoints_file = str(get_package_share_directory('ulsan_behaviour')) + '/config/waypoints.yaml'
