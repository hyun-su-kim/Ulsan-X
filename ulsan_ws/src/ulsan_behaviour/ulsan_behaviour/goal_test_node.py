"""
[임시 테스트 노드 — ulsan_voice 완성 후 삭제]
ulsan_voice(음성 파이프라인) 구현 전까지 /on_duty, /goal_destination을
키보드로 수동 발행하여 behaviour_node FSM 동작을 검증하는 용도.
ulsan_voice가 /goal_destination을, ulsan_coordinator가 /on_duty를 담당하게 되면 불필요.
"""
import yaml
import rclpy
...
def main():
    ...
    pkg = get_package_share_directory('ulsan_behaviour')
