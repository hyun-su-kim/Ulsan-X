...
from ulsan_behaviour.states import FailedState, GuidingState, IdleState, ReturningState, WaitingState
from nav2_simple_commander.robot_navigator import BasicNavigator


class BehaviourNode(Node):
    def __init__(self, waypoints: dict, domain_home_map: dict):
        super().__init__('ulsan_behaviour')
        ...
        self._diag_updater.setHardwareID('ulsan_behaviour')
        self._diag_updater.add('ulsan_behaviour', self._diag_check)
...
def main():
    ...
    pkg_share = get_package_share_directory('ulsan_behaviour')
